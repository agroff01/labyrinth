...
namespace Labyrinth
{
    ...
    public class FreecamController : MonoBehaviour
    {
        ...
        public static FreecamController Instance = null;
        ...
        void Update()
        {
            if (_cam)
            {
                _cam.enabled = GlobalCameraController.FreecamActive;
                _listener.enabled = GlobalCameraController.FreecamActive;
            }
            if (!GlobalCameraController.FreecamActive) return;
